...
void AISettingsPanel::buildUi()
{
  ...
  mcpTools->setText(QStringLiteral(
    ...
    "<li style='margin-bottom:4px;'><b>list_project_files / read_project_file / get_project_rules</b> — %6</li>"
    "<li style='margin-bottom:4px;'><b>get_model_info</b> — %7</li>"
    "<li style='margin-bottom:4px;'><b>get_preview_image</b> — %8</li>"
    "<li style='margin-bottom:4px;'><b>get_console_log</b> — %9</li>"
    "<li style='margin-bottom:4px;'><b>get_camera_info / pan_view / zoom_in / zoom_out / zoom_100 / view_all / reset_view</b> — %10</li>"
    "<li style='margin-bottom:0;'><b>list_tools</b> — %11</li>"
    "</ul>"
    "<p style='margin:8px 0 0 0; opacity:0.85;'>%12</p>")
    .arg(_("load bundled CAD workflow skills (openscad-cad)"),
         ...
         _("inspect open project files, assets, and rules"),
         ...
         _("Prompts: create_model, improve_model, fix_render. "
           "Best workflow: open Project → get_skill / get_project_rules → "
           "set_editor_code (F5) → get_preview_image → trigger_render once when done.")));
